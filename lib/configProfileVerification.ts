...
const buildEntries = () => {
  const entries: ConfigProfileVerificationEntry[] = [
    ...
    {
      key: 'posterTrendingTagPosition',
      coverageValues: ['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right'],
      browserFamily: 'quality-badge',
      surfaces: ['poster'],
    },
    {
      key: 'posterTrendingTagStyle',
      coverageValues: qualityBadgeStyleValues,
      browserFamily: 'quality-badge',
      surfaces: ['poster'],
    },
    {
      key: 'posterTrendingCommunityTheme',
      coverageValues: communityBadgeThemeValues,
      requiredParams: { posterTrendingTagStyle: 'community-badge' },
      browserFamily: 'quality-badge',
      surfaces: ['poster'],
    },
    {
      key: 'posterTrendingTagTextColor',
      coverageValues: HEX_COLOR_CASES,
      browserFamily: 'quality-badge',
      surfaces: ['poster'],
    },
