...
export const ALLOCINE_LOGO_DATA_URI = buildSvgDataUri(`
  <svg fill="#fecc00" width="256" height="256" viewBox="-2.4 -2.4 28.8 28.8" role="img" xmlns="http://www.w3.org/2000/svg" stroke="#fecc00" stroke-width="0.00024">
    <g stroke-width="0"/>
    <g stroke-linecap="round" stroke-linejoin="round" stroke="#000000" stroke-width="3.216">
