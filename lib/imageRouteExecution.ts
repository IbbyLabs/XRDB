  ...
  const renderedImage = await withDedupe(
    ...
    async () => {
      ...
      const preparedMedia = await prepareImageRouteMediaState({
        ...
        genreBadgeOffsetX: requestState.genreBadgeOffsetX,
        genreBadgeOffsetY: requestState.genreBadgeOffsetY,
      ...
      const renderedPayload = await renderWithSharp(
        {
          ...
          trendingTagPosition: requestState.trendingTagPosition,
          trendingTagStylePreset: requestState.trendingTagStylePreset,
          trendingTagTextColor: requestState.trendingTagTextColor,
