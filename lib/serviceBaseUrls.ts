...
export const DEFAULT_OMDB_API_BASE_URL = 'https://www.omdbapi.com';
...
export const resolveServiceBaseUrls = (env: Record<string, string | undefined> = process.env) => ({
  ...
  omdbApiBaseUrl: normalizeBaseUrl(env.XRDB_OMDB_API_BASE_URL, DEFAULT_OMDB_API_BASE_URL),
});
...
export const OMDB_API_BASE_URL = configuredServiceBaseUrls.omdbApiBaseUrl;
