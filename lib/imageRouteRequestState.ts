...
export const resolveImageRouteRequestState = async ({
  ...
  const renderSeedKey = buildFinalImageRenderSeedKey({
    ...
    ratingPresentation,
    scorebarStyle: scorebarConfig.style,
    scorebarLowColor: scorebarConfig.lowColor,
    scorebarMidColor: scorebarConfig.midColor,
    scorebarHighColor: scorebarConfig.highColor,
    scorebarLowThreshold: scorebarConfig.lowThreshold,
    scorebarHighThreshold: scorebarConfig.highThreshold,
