  ...
  return {
    inputsPanelProps: {
      ...
      presentationProps: {
        ...
        activeAggregateProviderWeights: workspaceSummary.activeAggregateProviderWeights,
        ...
        posterRingCenterOpacity: workspaceState.posterRingCenterOpacity,
        ...
        aggregateValueColor: workspaceState.aggregateValueColor,
        aggregateCriticsValueColor: workspaceState.aggregateCriticsValueColor,
        aggregateAudienceValueColor: workspaceState.aggregateAudienceValueColor,
        ...
        onSetAggregateProviderWeightsForType: workspaceSummary.setAggregateProviderWeightsForType,
        ...
        onSelectPosterRingCenterOpacity: workspaceState.setPosterRingCenterOpacity,
        ...
        onSelectAggregateValueColor: workspaceState.setAggregateValueColor,
        onSelectAggregateCriticsValueColor: workspaceState.setAggregateCriticsValueColor,
        onSelectAggregateAudienceValueColor: workspaceState.setAggregateAudienceValueColor,
      ...
      lookProps: {
        ...
        iconShape: workspaceState.iconShape,
        genreBadgeTileAccentColor: workspaceState.genreBadgeTileAccentColor,
        communityBadgeTheme: workspaceState.communityBadgeTheme,
        ...
        scorebarStyle: workspaceState.scorebarStyle,
        scorebarLowColor: workspaceState.scorebarLowColor,
        scorebarMidColor: workspaceState.scorebarMidColor,
        scorebarHighColor: workspaceState.scorebarHighColor,
        scorebarLowThreshold: workspaceState.scorebarLowThreshold,
        scorebarHighThreshold: workspaceState.scorebarHighThreshold,
        ...
        activeGenreBadgeOffsetX: activeWorkspaceSettings.activeGenreBadgeOffsetX,
        activeGenreBadgeOffsetY: activeWorkspaceSettings.activeGenreBadgeOffsetY,
        ...
        onSelectIconShape: workspaceState.setIconShape,
        onSelectGenreBadgeTileAccentColor: workspaceState.setGenreBadgeTileAccentColor,
        onSelectCommunityBadgeTheme: workspaceState.setCommunityBadgeTheme,
        ...
        onSelectScorebarStyle: workspaceState.setScorebarStyle,
        onSelectScorebarLowColor: workspaceState.setScorebarLowColor,
        onSelectScorebarMidColor: workspaceState.setScorebarMidColor,
        onSelectScorebarHighColor: workspaceState.setScorebarHighColor,
        onSelectScorebarLowThreshold: workspaceState.setScorebarLowThreshold,
        onSelectScorebarHighThreshold: workspaceState.setScorebarHighThreshold,
        ...
        onSelectGenreBadgeOffsetY: activeWorkspaceSettings.setActiveGenreBadgeOffsetY,
      ...
      qualityProps: {
        ...
        posterTrendingTagPosition: workspaceState.posterTrendingTagPosition,
        posterTrendingTagStylePreset: workspaceState.posterTrendingTagStylePreset,
        posterTrendingCommunityBadgeTheme: workspaceState.posterTrendingCommunityBadgeTheme,
        posterTrendingTagTextColor: workspaceState.posterTrendingTagTextColor,
        ...
        onSelectPosterTrendingTagPosition: workspaceState.setPosterTrendingTagPosition,
        onSelectPosterTrendingTagStylePreset: workspaceState.setPosterTrendingTagStylePreset,
        onSelectPosterTrendingCommunityBadgeTheme: workspaceState.setPosterTrendingCommunityBadgeTheme,
        onSelectPosterTrendingTagTextColor: workspaceState.setPosterTrendingTagTextColor,
        ...
        ageRatingTileColor: workspaceState.ageRatingTileColor,
        releaseStatusTileColor: workspaceState.releaseStatusTileColor,
        qualityBadgesTileAccentColor: workspaceState.qualityBadgesTileAccentColor,
        networkTileColor: workspaceState.networkTileColor,
        onSelectAgeRatingTileColor: workspaceState.setAgeRatingTileColor,
        onSelectReleaseStatusTileColor: workspaceState.setReleaseStatusTileColor,
        onSelectQualityBadgesTileAccentColor: workspaceState.setQualityBadgesTileAccentColor,
        onSelectNetworkTileColor: workspaceState.setNetworkTileColor,
        communityBadgeTheme: workspaceState.communityBadgeTheme,
        onSelectCommunityBadgeTheme: workspaceState.setCommunityBadgeTheme,
        ageRatingBadgeStyle: workspaceState.ageRatingBadgeStyle,
    ...
    workspaceColumnsProps: {
      ...
      exportPanelsProps: {
        ...
        episodeIdMode: workspaceState.aiometadataEpisodeIdMode,
        onSelectEpisodeIdMode: workspaceState.setAiometadataEpisodeIdMode,
        thumbnailEpisodeArtwork: workspaceState.thumbnailEpisodeArtwork,
        onSelectThumbnailEpisodeArtwork: workspaceState.setThumbnailEpisodeArtwork,
