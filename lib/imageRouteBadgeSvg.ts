...
export const buildBadgeSvg = ({
  ...
  const plainBadgeDefs =
    ratingStyle === 'plain'
      ? `<defs><filter id="text-shadow" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="1" stdDeviation="2.4" flood-color="#000000" flood-opacity="0.55" /></filter><filter id="plain-icon-shadow" x="-35%" y="-35%" width="170%" height="170%" color-interpolation-filters="sRGB"><feDropShadow dx="0" dy="0" stdDeviation="1.4" flood-color="#020617" flood-opacity="0.78" /><feDropShadow dx="0" dy="1" stdDeviation="2.2" flood-color="#020617" flood-opacity="0.46" /></filter>${preferReadablePlainSurface ? `<filter id="plain-badge-surface-shadow" x="-28%" y="-40%" width="156%" height="190%" color-interpolation-filters="sRGB"><feDropShadow dx="0" dy="2" stdDeviation="3.4" flood-color="#020617" flood-opacity="0.58" /><feDropShadow dx="0" dy="0" stdDeviation="1.6" flood-color="#020617" flood-opacity="0.26" /></filter><linearGradient id="plain-badge-surface-fill" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#020617" stop-opacity="0.16" /><stop offset="100%" stop-color="#0f172a" stop-opacity="0.11" /></linearGradient>` : ''}</defs>`
      : '';
...
<rect x="${highlightInsetX}" y="${highlightInsetY}" width="${highlightWidth}" height="${highlightHeight}" rx="${highlightRadius}" fill="rgba(255,255,255,0.035)" />`;
        })()
      : '';
