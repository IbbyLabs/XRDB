...
export function ProvidersPanel() {
  ...
  const providerPopupId = 'backdrop-provider-tuning';
...
export function StylePanel() {
  ...
  const presentationPopupId = 'backdrop-style-presentation';
  const aggregatePopupId = 'backdrop-style-aggregate';
  const scorebarPopupId = 'backdrop-style-scorebar';
  const appearancePopupId = 'backdrop-style-appearance';
  const genrePopupId = 'backdrop-style-genre';
  ...
  return (
    <div className="xrdb-panel-style">
      ...
      <PanelSection
        ...
        description="Controls how rating scores are displayed and the overall visual appearance of the backdrop."
      >
      ...
      <PanelSection
        ...
        description="Optional genre labels that add context to the backdrop artwork."
      >
        {ratingsEnabled ? (
      ...
      <ControlPopupDialog
        ...
        description="Choose how ratings are displayed on the backdrop."
        onClose={ui.closeControlPopup}
      >
...
export function PositionPanel() {
  ...
  const ui = ctx.workspaceUiProps;
  const positionPopupId = 'backdrop-position-placement';
  const ratingsEnabled = ratingProviderRows.some((row) => row.enabled);
  ...
  return (
    <div className="xrdb-panel-position">
      ...
      <ControlPopupDialog
        ...
        description="Layout, arrangement, and size of rating badges on the backdrop."
        onClose={ui.closeControlPopup}
      >
...
export function AdvancedPanel() {
  ...
  const look = ctx.inputsPanelProps.lookProps;
  const ui = ctx.workspaceUiProps;
  const limitsPopupId = 'backdrop-advanced-limits';
  ...
  return (
    <div className="xrdb-panel-advanced">
      ...
      <PanelSection
        ...
        description="Controls output size, readability helpers, and optional rating limits."
      >
...
export function QualityPanel() {
  ...
  const streamPopupId = 'backdrop-quality-stream';
  const stylePopupId = 'backdrop-quality-style';
  const customIconsPopupId = 'backdrop-quality-custom-icons';
  ...
  return (
    <div className="xrdb-panel-quality">
      ...
      <ControlPopupDialog
        ...
        title="Badge style"
        description="Style, sizing, and placement of quality badges on the backdrop."
        onClose={ui.closeControlPopup}
      >
