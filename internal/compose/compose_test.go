...
func TestRatingsMatchAcrossPosterAndBackdrop(t *testing.T) {
	for _, ct := range []string{"series", ""} {
		...
		pr, _, _, _, _, _ := p.collectRatingsWithProviders(context.Background(), poster, nil)
		br, _, _, _, _, _ := p.collectRatingsWithProviders(context.Background(), backdrop, nil)
...
func TestCollectRatingsMergesProviders(t *testing.T) {
	...
	all, _, _, _, _, _ := p.collectRatingsWithProviders(context.Background(), req, artwork)
...
func TestCollectRatingsDeduplicatesAcrossProviders(t *testing.T) {
	...
	all, _, _, _, _, _ := pipe.collectRatingsWithProviders(context.Background(), req, artwork)
...
func TestCollectRatingsSkipsArtworkProvider(t *testing.T) {
	...
	all, _, _, _, _, _ := pipe.collectRatingsWithProviders(context.Background(), req, initial)
...
func TestTopRatedRankReachesTheBadgeMeta(t *testing.T) {
	...
	req := Request{MediaType: "poster", ContentType: "movie", MediaID: "tt1", Config: cfg}
	if _, _, _, _, _, _ = p.collectRatingsWithProviders(context.Background(), req, artwork); artwork.TopRatedRank != 42 {
...
func TestUnrankedTitleCarriesNoRank(t *testing.T) {
	...
	artwork := &provider.MediaMeta{}
	req := Request{MediaType: "poster", ContentType: "movie", MediaID: "tt1", Config: cfg}
	if _, _, _, _, _, _ = p.collectRatingsWithProviders(context.Background(), req, artwork); artwork.TopRatedRank != 0 {
