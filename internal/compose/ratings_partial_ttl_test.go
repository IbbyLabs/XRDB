...
func TestAPartialAnswerTakesTheShorterTerm(t *testing.T) {
	...
	_, err := c.do(context.Background(), "mdblist|movie|tt1", titleAge{}, func(context.Context) (*provider.MediaMeta, bool, error) {
...
func TestACompleteAnswerTakesTheFullTerm(t *testing.T) {
	...
	if _, err := c.do(context.Background(), "mdblist|movie|tt2", titleAge{}, func(context.Context) (*provider.MediaMeta, bool, error) {
...
func TestTheShorterTermNeverExtendsAConfiguredTTL(t *testing.T) {
	...
	if _, err := c.do(context.Background(), "mdblist|movie|tt3", titleAge{}, func(context.Context) (*provider.MediaMeta, bool, error) {
		return oneRating("imdb"), false, nil
	}); err != nil {
		t.Fatal(err)
	}
