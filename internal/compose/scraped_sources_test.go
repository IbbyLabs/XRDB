...
func TestScrapedSourceIsSkippedWhenNotSelected(t *testing.T) {
	...
	all, _, _, _, _, _ := p.collectRatingsWithProviders(context.Background(), req, artworkMeta())
...
func TestScrapedSourceIsCalledByTitleWhenSelected(t *testing.T) {
	...
	all, contributors, _, _, _, _ := p.collectRatingsWithProviders(context.Background(), req, artworkMeta())
