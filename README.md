...
| `iconShape` | Clipping shape applied to rating provider icons (Letterboxd, IMDb, etc.) | `original` \| `circle` \| `squircle` \| `rounded` | `original` |
...
iconShape               | original, circle, squircle, rounded — clipping shape applied to rating provider icons       | original
